...
<ul style="list-style-type:disc">
  <li>This <b>AWS Full-Stack Developer Template</b> provides fully functional end-to-end build pipeline from Spring Boot source code to AWS Infrastructure</li> 
